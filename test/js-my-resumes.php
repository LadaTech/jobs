...
if(strpos('content writer', strtolower($q)) !== false) { $rr="or cwid!='0'"; }
if(strpos('self', strtolower($q)) !== false) { $rr="or cwid='0'"; }
}
...
?>    
            <tr><td>JR<?php echo date("dmy", strtotime($row_dom['created_on'])); ?><?php echo sprintf("%03d", $row_dom['id']); ?></td><td><?php if($row_dom["cwid"]!="0"){ echo "Content Writer"; } else { echo "Self"; } ?></td>
<!--                <td><?php if($row_dom["pdf_file"]!=""){ echo ""; } else { echo "-"; } ?></td>-->
