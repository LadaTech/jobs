...
else{ ?> <table class="table-wrapper"> <thead><tr><th>Language Name</th> <th>Profficiency Level</th><th>Read</th><th>Write</th><th>Speak</th></tr></thead> <?php
while($rec_j = $lang->fetch(PDO::FETCH_ASSOC)){
$lc++;     
?> <tr>
        <td><?php echo $rec_j["language_name"]; ?></td>
        <td><?php echo $rec_j["profficiency_level"]; ?></td>
        <td><?php if($rec_j["lang_read"]=="1"){ echo "Yes"; } ?></td>
        <td><?php if($rec_j["writes"]=="1"){ echo "Yes"; } ?></td>
        <td><?php if($rec_j["speaks"]=="1"){ echo "Yes"; } ?></td>
    </tr>
<?php } ?></table> <?php } ?>    </div>
...
else{ ?> <table class="table-wrapper"> <thead><tr><th>Education Name</th> <th>Course</th><th>Institute Name</th><th>% or CGPA</th><th>Start date</th><th>End date</th></tr></thead> <?php
while($rec_j = $lang->fetch(PDO::FETCH_ASSOC)){
$lc++;     
?> <tr>
...
else{ ?> <table class="table-wrapper"> <thead><tr><th>Company Name</th><th>Designation</th><th>Current CTC</th><th>Expected CTC</th><th>Start date</th><th>End date</th></tr></thead> <?php
while($rec_j = $lang->fetch(PDO::FETCH_ASSOC)){
$lc++;     
?> <tr>
