...
<div class="row profile">
    <div class="col-sm-8">
        <h3 class="main-heading">My Orders
 <form class="s_form" action="<?php echo $my_path; ?>/cw/my-orders.aspx">
                <div class="">
...
{
$msg=$_GET['msg'];
if($msg=='resume-completed')
{
?>
<div class="alert alert-success alert-dismissable">
<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
<h4>	<i class="icon fa fa-check"></i> Resume Creation has been completed and sent to Job Seeker. </h4>
</div>
<?php   
}
if($msg=='resume-saved')
...
<div class="alert alert-success alert-dismissable">
<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
<h4>	<i class="icon fa fa-check"></i> Resume Creation has been saved and Please complete soon. </h4>
</div>
<?php   
}
if($msg=='canceled')
...
<!--                <td><?php echo $row_dom["iname"]; ?></td>
               ...
               -->
                ...
                <td class="clone_data hide">
                    ...
                    <a href="<?php echo $my_path; ?>/cw/i-<?php echo $row_dom["id"]; ?>/create-resume.aspx" class="btn btn-primary open2"><i class="fa fa-edit"></i> Create Resume</a>
