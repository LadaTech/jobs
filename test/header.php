...
<a class="navbar-brand" href="<?php echo $my_path; ?>/job-seeker/dashboard.aspx"><img src="<?php echo $my_path; ?>/images/logo_js.png" alt="logo"></a>

<?php elseif(isset($_SESSION["cwid"])): ?>
<a class="navbar-brand" href="<?php echo $my_path; ?>/cw/dashboard.aspx"><img src="<?php echo $my_path; ?>/images/logo_cw.png" alt="logo"></a>
<?php else: ?>
