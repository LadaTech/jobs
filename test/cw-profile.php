...
<div class="padding-10">  <input type="radio"  id="ptype" name="Gender" class="" value="Male" required="" <?php if ($user_info["Gender"] == "Male") {
echo "checked";
} ?>> Male
    &nbsp;&nbsp;&nbsp;
    <input type="radio"  id="ptype" name="Gender" class="" value="Female" required="" <?php if ($user_info["Gender"] == "Female") {
echo "checked";
} ?>> Female </div>
...
<?php for($k=0;$k<50;$k++) { ?> <option value="<?php echo $k; ?>" <?php if($k==$user_info["exp_yrs"]) { echo "selected"; } ?> ><?php echo $k; ?> Years</option><?php } ?>
...
<?php if($k==$user_info["exp_mnths"]) { echo "selected"; } ?>        
...
<option value="PG" <?php if($user_info["Education"]=="PG") { echo "selected"; }?>>PG</option>
<option value="Degree" <?php if($user_info["Education"]=="Degree") { echo "selected"; }?>>Degree</option>
<option value="Inter" <?php if($user_info["Education"]=="Inter") { echo "selected"; }?>>Inter</option>
<option value="SSC" <?php if($user_info["Education"]=="SSC") { echo "selected"; }?>>SSC</option>
</select>
</div>     
<div class="col-lg-6">
