...
$sql1=$db->query("select * from content_writer where Email_id='$q' and email_verification_status=0") or die(mysql_error());
    if($sql1->rowCount()=='1')
    {
...
<p><a href='$my_path/cw/login/$res[email_verification]/activation.aspx'>Click here for activate your account</a></p>
  <p>  or </p><br/>
<p>(Copy Below link and paste it into browser new tab)    </p>
<p>$my_path/cw/login/$res[email_verification]/activation.aspx</p>
...
$p_a=$my_path."/cw/login/activatelinksent.aspx";
header("Location: $p_a");   
    }
    else
    {
$p_a=$my_path."/cw/login.aspx";
header("Location: $p_a");   
    }
