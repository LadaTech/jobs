...
Viewer.a11 = function(div, viewer, a44) {
    var h = '';
    for (key in Viewer.a15) {
        var template = Viewer.a15[key];
        h += '<img class="thumb template-' + template.name + '" data-key="' + key + '" src="templates/img/templates/' + template.name + '.png?d19" width="80" height="120"/>';
    }
    var $dd = $(div);
...
Viewer.a15.T1 = {
    ...
    experience: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    html: '[person]<table class="wide"><tr><td class="left">[contact]</td><td class="right">[blocks]</td></tr></table>'
};
Viewer.a15.T2 = {
    name: 'T2',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:0 0 .6em}' + '%00 div.blocks *{line-height:1.4em}' + '%00 div.block p.person{font-size:3em;margin-bottom:0;padding:0 .2em;line-height:1em}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:.5em 0 0;border-top:1px solid #a77;padding:.3em 10px 0 0}' + '%00 div.block p.location{font-size:1em;color:#fff;padding-right:10px}' + '%00 div.block p.title{font-size:1.3em;font-weight:bold;margin-bottom:.5em;color:#800}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.blocks{padding-top:13em}' + '%00 div.block.person{margin-top:[#vertical]mm;text-align:right;border-color:transparent}' + '%00 div.block.contact{margin:[#vertical]mm [#_hRelative]% 0 1em !important;border-color:transparent;font-size:1.2em;color:#555}' + '%00 table.wide{position:absolute;width:[#_paperWidth]mm;border-collapse:collapse;margin:-[#vertical]mm -[#_hRelative]% 0 -[#_hRelative]%}' + '%00 table.wide > tbody{display:inline-table;width:[#_paperWidth]mm;padding-left:[#_hRelative]%;padding-right:[#_hRelative]%}' + '%00 td.left{width:50%;vertical-align:top;background:#800;border-right:4px solid #000;color:#fff;padding-left:[#horizontal]%;padding-bottom:2em}' + '%00 td.right{width:50%;vertical-align:top;background:#eee;border-left:4px solid #000;line-height:2em}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    html: '<table class="wide"><tbody><tr><td class="left">[person]</td><td class="right">[contact]</td></tr></tbody></table><div class="blocks">[blocks]</div>',
    getFix: function(container, factor) {
        var $tb = $(container + ' table.wide');
        var h = $tb.height() + parseFloat($tb.css('margin-top')) / 2.0;
        h = factor ? h * factor : h;
        return container + ' div.blocks{padding-top:' + h + 'px}';
    }
};
Viewer.a15.T3 = {
    name: 'T3',
    stylesheet: '%00 table.person{margin-left:-0.3em}' + '%00 td.firstname{font-size:3em;height:.5em;padding:0}' + '%00 td.lastname{font-size:5em;height:1em;padding:.05em 0;line-height:1em}' + '%00 div.block p{line-height:1.2em;margin:0 0 .6em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0 0 .2em}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0 0 .2em}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:.6em 0 .2em}' + '%00 div.block p.location{font-size:1em;color:#555}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:1.3em;font-weight:bold;margin-bottom:.5em;padding-bottom:.2em;border-bottom:.2em solid #ddd}' + '%00 div.blocks *{line-height:1.4em;}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}',
...
Viewer.a15.T6 = {
    ...
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    html: '<table class="wide"><tr><td class="left">[person]</td><td class="right">[contact]</td></tr></table><div class="blocks">[blocks]</div>',
    blockTitleWrap: '<table class="wide title" cellspacing="0"><tr><td class="block-title">%1</td><td class="block-title"></td></tr></table>'
};
Viewer.a15.T7 = {
    name: 'T7',
...
Viewer.a15.T8 = {
    name: 'T8',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:0 0 .6em}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0;line-height:1.2em;margin-top:-.2em;}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:0}' + '%00 div.block p.location{font-size:1em;color:#555;margin:0}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:140%;font-weight:bold;margin:0 0 .5em 0;padding:.2em .5em;text-transform:uppercase;border-bottom:.4em solid #ddd}' + '%00 div.blocks{margin-top:1em}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}' + '%00 td.left0{width:35%;vertical-align:top;padding:0}' + '%00 td.right0{width:65%;vertical-align:top;border-left:.5em solid #ddd;padding-left:.8em}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
...
Viewer.a15.T9 = {
    name: 'T9',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:.5em 0 .6em}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0;line-height:1.2em;margin-top:-.2em;}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:0}' + '%00 div.block p.location{font-size:1em;color:#555;margin:0}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:140%;font-weight:bold;margin:0 0 .5em 0;padding:.2em .5em;text-transform:uppercase;background:#ddd}' + '%00 div.blocks{margin-top:1em}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}' + '%00 td.left0{width:35%;vertical-align:top;padding:0}' + '%00 td.right0{width:65%;vertical-align:top;border-left:.5em solid #ddd;padding-left:.8em}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
...
Viewer.a15.T10 = {
    name: 'T10',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:0 0 .6em}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0;line-height:1.2em;margin-top:-.2em;}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:0}' + '%00 div.block p.location{font-size:1em;color:#555;margin:0}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:1.3em;font-weight:bold;margin:0 0 .5em 0;padding:.1em .5em;text-transform:uppercase;background:#ddd;border-left:.2em solid #999;-moz-border-radius:.5em;-webkit-border-radius:.5em;border-radius:.5em;border-top-left-radius:.5em;border-top-right-radius:.5em;border-bottom-right-radius:.5em;border-bottom-left-radius:.5em}' + '%00 div.blocks{margin-top:1em}' + '%00 div.child{border-bottom:.2em dotted #bbb;padding-bottom:1em}' + '%00 div.last-child{border-bottom:none;padding-bottom:0}' + '%00 div.block-inner{margin-left:2em}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
...
Viewer.a15.T11 = {
    name: 'T11',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:0 0 .6em}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0;line-height:1.2em;margin-top:-.2em;}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:0}' + '%00 div.block p.location{font-size:1em;color:#555;margin:0}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:1.3em;font-weight:bold;margin:0 0 .5em 0;padding:.1em .3em;text-transform:uppercase;border-top:.2em solid #bbb}' + '%00 div.blocks{margin-top:1em}' + '%00 div.child{padding-left:1.5em;border-left:.2em dotted #bbb}' + '%00 div.last-child{padding-left:1.5em;border-left:.2em dotted #bbb}' + '%00 div.circle{border:.1px solid #659AD3;background:#659AD3;width:1.2em;height:1.2em;float:left;margin-top:.3em;margin-left:-2.2em;-moz-border-radius:.6em;-webkit-border-radius:.6em;border-radius:.6em;border-top-left-radius:.6em;border-top-right-radius:.6em;border-bottom-right-radius:.6em;border-bottom-left-radius:.6em}' + '%00 div.block-inner{margin-left:2em}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '<span style="margin-top:-1em"></span><div class="circle"></div>' + '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    education: '<div class="circle"></div>' + '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    html: '<table class="wide"><tr><td class="left">[person]</td><td class="right">[contact]</td></tr></table><div class="blocks">[blocks]</div>'
};
Viewer.a15.T12 = {
    name: 'T12',
    stylesheet: '%00 div.block p{line-height:1.4em;margin:0 0 .6em}' + '%00 div.block p.sub-title{font-size:1.2em;font-weight:bold;margin:0}' + '%00 div.block p.sub-where{font-size:1.1em;margin:0}' + '%00 div.block p.sub-dates{font-size:1em;color:#555;margin:0 0 .5em}' + '%00 div.block p.person{font-size:4em;margin-bottom:0;line-height:1.2em;margin-top:-.2em;}' + '%00 div.block p.jobtitle{font-size:1.2em;margin:0}' + '%00 div.block p.location{font-size:1em;color:#555;margin:0}' + '%00 div.block span.company{color:#555;font-weight:bold}' + '%00 div.block p.title{font-size:1.3em;font-weight:bold;margin:0 0 .5em 0;padding:.1em .3em;text-transform:uppercase;background:#eee}' + '%00 div.blocks{margin-top:1em}' + '%00 div.block-inner{margin-left:2em}' + '%00 td.sub-left{width:35%;text-align:right;vertical-align:top;padding-right:2em}' + '%00 td.sub-right{width:65%;padding:.3em 0;vertical-align:top}' + '%00 div.child{border-bottom:.2em solid #bbb;padding-bottom:.7em}' + '%00 div.last-child{border:none;padding-bottom:0}' + '%00 table.wide{width:100%;border-collapse:collapse}' + '%00 td.left{width:65%;vertical-align:top}' + '%00 td.right{width:35%;vertical-align:top;text-align:right}',
    person: '<p class="person">[#firstName] [#lastName]</p>' + '[<p class="jobtitle">|#jobTitle|</p>]' + '[<p class="location">|#location|</p>]',
    contact: '<div class="html-content">[#html]</div>',
    experience: '<table class="wide"><tr><td class="sub-left">' + '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where"><span class="company">|+where|</span>, |+location|</p>]' + '[<p class="sub-dates">|+fromMonth| |+fromYear|<_ &ndash; _>|+toMonth| |+toYear|</p>]' + '</td><td class="sub-right"><div class="html-content">[#html]</div></td></tr></table>',
    education: '[<p class="sub-title">|#title|</p>]' + '[<p class="sub-where">|+where|, |+location|</p>]' + '[<p class="sub-dates">|+fromYear| &ndash; |+toYear|</p>]' + '<div class="html-content">[#html]</div>',
    html: '<table class="wide"><tr><td class="left">[person]</td><td class="right">[contact]</td></tr></table><div class="blocks">[blocks]</div>'
};