    ...
    if ($stmt_dom->rowCount() > 0) {
        while ($row_dom = $stmt_dom->fetch(PDO::FETCH_ASSOC)) {
         //   echo $row_dom['domain_name'];
            ...
            <option  value="<?php echo $row_dom['id']; ?>" <?php if ($payment["did"] == $row_dom['id']) {
        echo "selected";
    } ?>><?php echo $row_dom['name']; ?></option>
<?php
}
...
<select class="form-control" id="expected_special_delivery" name="expected_special_delivery">
     <option value="3" <?php if ($payment["expected_special_delivery"] == "3") {
        echo "selected";
    } ?>>0-3 Business Days</option>
     <option value="5" <?php if ($payment["expected_special_delivery"] == "5") {
        echo "selected";
    } ?>>3-5 Business Days</option>
     <option value="7" <?php if ($payment["expected_special_delivery"] == "7") {
        echo "selected";
...
<select class="form-control" id="expected_special_delivery" name="expected_delivery">
      <option value="3" <?php if ($payment["expected_delivery"] == "3") {
        echo "selected";
    } ?>>0-3 Business Days</option>
     <option value="5" <?php if ($payment["expected_delivery"] == "5") {
        echo "selected";
    } ?>>3-5 Business Days</option>
     <option value="7" <?php if ($payment["expected_delivery"] == "7") {
        echo "selected";
    } ?>>5-7 Business Days</option>
</select>
</div>       
